...
public class InterestManager {
    ...
    public void applyInterest() {
        ...
        for (UUID uuid : uuids) {
            ...
            String notification = ChatColor.GRAY + "You have been paid " + ChatColor.GREEN + "$" + round(newInterestPayment, 2) + ChatColor.GRAY + " in interest for " + ChatColor.GREEN + currentMonth + ChatColor.GRAY + " as you where online in the last 30 days.";
