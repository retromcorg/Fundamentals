...
public class Metrics {
  ...
  public Metrics(JavaPlugin plugin, int serviceId) {
    ...
    if (config.getProperty("serverUuid") == null) {
      ...
      config.setProperty("serverUuid", UUID.randomUUID().toString());
      config.setProperty("logFailedRequests", false);
      config.setProperty("logSentData", false);
      config.setProperty("logResponseStatusText", false);
    }
